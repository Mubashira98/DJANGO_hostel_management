    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_name', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='APP.student_register', unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(max_length=250)),
                ('approval_status', models.IntegerField(default=0)),
                ('student_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='APP.student_register')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hostel_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='APP.hostel')),
            ],
        ),
        migrations.CreateModel(
            name='Complaint',
            fields=[
                ...
                ('student_name', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='APP.student_register')),
            ],
        ),
        migrations.CreateModel(
            name='Attendance',
            fields=[
                ...
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='APP.student_register')),
            ],
        ),
    ]
